  ...
  init() {
    ...
    const material = new THREE.ShaderMaterial({
      ...
      uniforms: Object.assign(
        ...
        (typeof this.options.distortion === 'object' && this.options.distortion !== null ? this.options.distortion.uniforms : {}) || {}
      )
    });
    ...
    material.onBeforeCompile = shader => {
      shader.vertexShader = shader.vertexShader.replace(
        ...
        (typeof this.options.distortion === 'object' && this.options.distortion !== null) ? this.options.distortion.getDistortion : ''
      );
    };
...
class App {
  ...
  update(delta: number) {
    ...
    if (typeof this.options.distortion === 'object' && this.options.distortion !== null && this.options.distortion.getJS) {
...
const Hyperspeed: FC<HyperspeedProps> = ({ effectOptions = {}, children, className = "" }) => {
  ...
  return (
    <div className={`relative w-full h-full ${className}`}>
        <div id="lights" className="w-full h-full absolute inset-0" ref={hyperspeed}></div>
        {children && (
